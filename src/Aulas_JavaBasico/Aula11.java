...
public class Aula11 {
    public static void main(String[] args) {
        ...
        System.out.println("Nome completo: ".concat(nome).concat(" ").concat(sobrenome)); // redução de: "" + nome + "" + sobrenome
        ...
        resultado = sc.next();
        char resposta = resultado.toLowerCase().charAt(0); // pega apenas a primeira letra
        if (resposta == 's') {
            System.out.println("----------------------------");
