...
public class HerancaBancaria {
    ...
    public static void main(String[] args) {
        ...
        ContaPoup contaPoupanca = new ContaPoup(numeroConta, titular, saldo, taxaJuros);
    ...
    class ContaBanc {
        ...
        public ContaBanc(int numero, String titular, double saldo) {
            this.numero = numero;
    ...
    class ContaPoup extends ContaBanc {
        private final double taxaJuros;

        public ContaPoup(int numero, String titular, double saldo, double taxaJuros) {
